...
////		details.setUserAuthorizationUri("http://localhost:1025/oauth/authorize");
...
//	@Bean
//	@Primary
//	public OAuth2RestTemplate oauth2RestTemplate(OAuth2ProtectedResourceDetails resourceService,OAuth2ClientContext clientContext) {
